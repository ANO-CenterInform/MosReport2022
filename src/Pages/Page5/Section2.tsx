        ...
        <PageLayout id={5} links={4} prevPage={'/pages/5/1'} nextPage={'/pages/5/3'}>
            <SectionLayout title={'АНАЛИЗ СТРУКТУРЫ АКТИВОВ ОБЩЕСТВА'}>
                ...
                <SingleParagraph extraClass={'mb:8 lg:mb-24'}>
                    Краткосрочные обязательства увеличились относительно 2020 года на 38 552 966 тыс. руб. и представлены кредиторской задолженностью с долей в валюте баланса 76% и оценочными обязательствами (резервы предстоящих расходов) с долей в валюте баланса 2%.
