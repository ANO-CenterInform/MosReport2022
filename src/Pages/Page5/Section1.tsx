    ...
    return (
        <PageLayout id={5} links={4} prevPage={'/pages/4/2'} nextPage={'/pages/5/2'}>
            <SectionLayout title={'АНАЛИЗ ФИНАНСОВЫХ РЕЗУЛЬТАТОВ ДЕЯТЕЛЬНОСТИ ОБЩЕСТВА'}>
                ...
                <SingleParagraph extraClass={'mb-24'}>В анализируемом периоде относительно итогов 2020 года наблюдается разнонаправленная динамика показателей «Выручка» и «Чистая прибыль».
                    Рост показателя «Выручка» на 4 384 426 тыс. руб. (2%) обусловлен освоением большего объема работ за счет оптимизации производственных про- цессов, использованием современных инновационных разработок в области проектирования и строительства. Ори- ентация на глобальные тенденции развития с учетом меняющихся внешних факторов и ожиданий заинтересован- ных сторон обеспечивает устойчивое развитие и рост.</SingleParagraph>
            </SectionLayout>
        </PageLayout>
    );
}
