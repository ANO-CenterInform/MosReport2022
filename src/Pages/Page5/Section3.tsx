    ...
    return (
        <PageLayout id={5} links={4} prevPage={'/pages/5/2'} nextPage={'/pages/5/4'}>
            <SectionLayout title={'АНАЛИЗ ФИНАНСОВОГО СОСТОЯНИЯ ОБЩЕСТВА'}>
                ...
                <TwoColumns>
                    <TwoColumns.Column>
                        <p>Коэффициент абсолютной ликвидности показывает способность погасить краткосрочные долги за счет наиболее ликвидных средств (краткосрочных финансовых вложений и денежных средств). По состоянию на конец 2021 года показатель снизился до нижней границы рекомендуемых значений за счет переквалификации краткосрочных финансовых вложений в долгосрочные. Показатель находится в районе рекомендованных значений и, не смотря на снижение, Общество может также рассчитаться по текущим обязательствам. Коэффициент срочной ликвидности по итогам 2021 года составил 0,81 и находится в рамках нормативного диапазона,</p>
                    </TwoColumns.Column>
                    <TwoColumns.Column>
                        <p>что говорит о возможности Общества достаточно быстро погашать свои текущие обязательства за счет высоколиквидных активов (краткосрочной дебиторской задолженности, финансовых вложений и денежных средств).
                            Показатели финансовой устойчивости Общества отражают соотношение собственных и заемных средств в источниках финансирования Общества и характеризуют степень финансовой независимости акционерного общества от кредиторов. Основные показатели финансовой устойчивости представлены в таблице:</p>
                    </TwoColumns.Column>
                </TwoColumns>
                <div className={'flex overflow-x-auto mb-8'}>
                ...
                <SingleParagraph>
                    Ввиду задержки регистрации вклада города Москвы в уставный капитал АО «Мосинжпроект» показатель «Кредиторская задолженность» увеличен на сумму задолженности перед учредителем Общества (21 456 820 тыс руб.). При прочих равных условиях и регистрации уставного капитала в периоде поступления вкладов учредителей показатели финансовой независимости составили бы:
                </SingleParagraph>
                <div className={'flex overflow-x-auto mb-8'}>
                ...
                <TwoColumns>
                    <TwoColumns.Column>
                        <p className={'mb-4'}>
                            Показатель «Оборачиваемость чистого оборотного капитала» составил 12,18 по состоянию на конец 2021 года, что демонстрирует эффективность использования инвестиций в оборотный капитал Общества и их положительное влияние на рост выручки от продаж. Чем выше значение этого коэффициента, тем более эффективно акционерное общество использует чистый оборотный капитал.
                        </p>
                        <p className={'mb-4'}>
                            Снижение коэффициента «Оборачиваемость основных средств» в 2021 году с 68,52 до 38,43 связано с ростом стоимости основных средств за счет ввода в эксплуатацию земельных участков и зданий со сроком полезного использования свыше 30 лет, полученных от города в качестве вклада в уставный капитал с целью реализации инвестиционных проектов. Увеличение фонда основных средств не повлияло на эффективность их использования Обществом.
                ...
                <SingleParagraph extraClass={'text-gray-500'}>
                    <span className={'font-bold'}>Показатели рентабельности Общества</span> показывают прибыльность финансово-хозяйственной деятельности. Основные показатели деловой активности представлены в таблице:
                </SingleParagraph>
                <div className={'flex overflow-x-auto mb-8'}>
