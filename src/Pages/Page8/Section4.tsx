            ...
            <SectionLayout title={'Подготовка КАДРОВ'}>
                ...
                <TwoColumns extraClass={'mb-8'}>
                    <TwoColumns.Column>
                        ...
                        <p className={'mb-6'}>
                            1. Разработана корпоративная модель компетенций с индивидуальным набором компетенций и поведенческими индикаторами для 4-х категорий позиций: Эксперт, Руководитель среднего звена, Руководитель старшего звена, Руководитель ТОП уровня. Сформирован документ «Руководство по оценке компетенций персонала.»
                        </p>
                    </TwoColumns.Column>
                    <TwoColumns.Column>
                        <p className={'mb-6'}>
                ...
                <TwoColumns extraClass={'mb-8'}>
                    ...
                    <TwoColumns.Column>
                        <ul className={'list-disc list-inside'}>
                            ...
                            <li>
                                продолжено сотрудничество в отраслевом контексте с профильными вузами, учебными центрами Комплекса градостроительной политики и строительства г. Москвы (МГСУ, МАДИ, МГУУ при Правительстве Москвы и др.);
                            </li>
                            <li>
