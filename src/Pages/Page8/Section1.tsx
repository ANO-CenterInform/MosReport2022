                ...
                <TwoColumns extraClass={'mb-8'}>
                    ...
                    <TwoColumns.Column>
                            <ul className={'list-inside list-decimal'}>
                                ...
                                <li>
                                    осуществляется эффективный поиск и подбор кандидатов, а также адаптация и всесторонняя поддержка вновь принятых сотрудников во время испытательного срока.
                                </li>

                            </ul>
                            <p>
                                В рамках предпринятых мер по обеспечению охраны здоровья персонала и обеспечению функционирования Общества при пандемии COVID-19 в 2021 году были закуплены и выданы сотрудникам средства индивидуальной защиты на общую сумму 8 644 755 руб. В течение 2021 года также проводилась дезинфицирующая обработка рабочих мест методом сухого тумана и всех помещений, находящихся в собственности или аренде Общества.
                            </p>
                    </TwoColumns.Column>
                </TwoColumns>
                <div className={'mb-24'}>
