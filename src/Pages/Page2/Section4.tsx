    ...
    return (
        <PageLayout id={2} links={7} prevPage={'/pages/2/3'} nextPage={'/pages/2/5'}>
            <SectionLayout title={'ПРИОРИТЕТНЫЕ НАПРАВЛЕНИЯ ДЕЯТЕЛЬНОСТИ'}>
                ...
                <SingleParagraph>Для реализации поставленных задач по развитию транспортной инфраструктуры в АИП Москвы в период 2022-2024 запланированы следующие объемы финансирования:</SingleParagraph>
