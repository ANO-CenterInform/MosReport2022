        ...
        <PageLayout id={2} links={pageLinks} prevPage={'/pages/2/4'} nextPage={'/pages/2/6'}>
            <SectionLayout title={'КОНКУРЕНТНОЕ ОКРУЖЕНИЕ АКЦИОНЕРНОГО ОБЩЕСТВА И ФАКТОРЫ РИСКА. УПРАВЛЕНИЕ РИСКАМИ, ВЛИЯНИЕ ПАНДЕМИИ'}>
                ...
                <div className={'flex flex-col lg:flex-row flex-wrap items-center justify-center bg-neutral-100 p-8 mb-8'}>
                    ...
                    <div className={'flex flex-col items-center text-center border-l border-r border-dashed border-gray-500 lg:w-1/3 px-8'}>
                        <div className={'shrink-0 mb-6'}>
                            <img className={'mx-auto'} src={icon_worker} alt={''}/>
                        </div>
                        <p>Нехватка рабочих на стройках — по предварительной оценке Минстроя дефицит составил около 3 млн человек8</p>
                    </div>
                    <div className={'flex flex-col items-center text-center lg:w-1/3 px-8'}>
                        <div className={'shrink-0 mb-6'}>
                ...
                <SingleParagraph>В результате рост себестоимости строительства составил более 15%9.
                    <br/>Непростая геополитическая ситуация, ослабление национальной валюты, сокраще- ние возможностей банковского сектора, угроза очередных волн пандемии COVID-19 являются существенными факторами риска для строительной отрасли РФ. В условиях потенциального снижения объема проектного финансирования ожидается обострение конкурентной борьбы.
                </SingleParagraph>
                <div className={'mb-8 pt-8 border-t border-gray-400'}>
                ...
                <div className={'flex flex-col lg:flex-row flex-wrap items-center justify-center bg-neutral-100 p-8 mb-8'}>
                    ...
                    <div className={'flex flex-col items-center text-center lg:w-1/3 border-l border-r border-dashed border-gray-500'}>
                        <div className={'shrink-0 mb-6'}>
