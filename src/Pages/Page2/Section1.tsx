...
export default function Section1() {
    return (
        <SectionLayout id={'first'} title={'ОБЩИЕ СВЕДЕНИЯ, ПОЛОЖЕНИЕ АКЦИОНЕРНОГО ОБЩЕСТВА В ОТРАСЛИ'} >
            <div className={'relative flex flex-col justify-center items-center lg:flex-row px-10 h-80 lg:gap-10 bg-mosBlue-700 text-white'}>
                ...
                <div className={'flex flex-col lg:flex-row items-center lg:w-2/3 justify-center lg:justify-end uppercase'}>
