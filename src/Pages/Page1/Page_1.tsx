...
import img8 from '../../../public/images/page1_img8.jpg';
import img9 from '../../../public/images/page1_img9.jpg';
import img10 from '../../../public/images/page1_img10.jpg';
    ...
    return (
        <main className="relative grid sm:grid-cols-[7rem_1fr]">
            ...
            <section className="md:max-w-bootstrap-md 2xl:max-w-bootstrap-full mx-auto pt-10">
                ...
                <div className={"flex flex-wrap mb-8 md:flex-nowrap gap-[30px]"}>
                    ...
                    <div className="flex flex-col xl:basis-[359px]">
                ...
                <div className={'mb-8'}>
                    ...
                    <div className={'p-8 bg-neutral-100 flex flex-wrap lg:flex-nowrap'}>
                        <img src={img10} alt={''}/>
                        <p className={'pl-8'}>Строительством уникального, знакового для России объекта «Национальный космический центр», который станет одним из крупнейших в мире космических центров. Площадь объектов превысит 250 тыс. кв. метров. Высотной доминантой комплекса зданий будет 288-метровая башня со шпилем. Именно на строительстве Национального космического центра тестируются и внедряются новые технологии на разных этапах строительного производства, охраны труда, промышленной безопасности.</p>
                    </div>
                </div>{/*Block end*/}
                ...
                <div className={'flex flex-wrap lg:flex-nowrap lg:gap-6 mb-8 justify-center lg:justify-between'}>
                    <div className={'flex flex-col justify-between gap-6'}>
                        ...
                        <div className={'flex flex-wrap lg:flex-nowrap lg:gap-6 lg:justify-between'}>
                            <img src={img11} alt={''}/>
                ...
                <div className={'flex flex-col lg:flex-row flex-wrap lg:flex-nowrap bg-neutral-100 p-6 mb-8 justify-center gap-6'}>
